...
class Environment:
    ...
    #             random_action[i] = np.random.uniform(-1, 0)
    #         else:
    #             random_action[i] = np.random.uniform(0, 1)
    #     return random_action

    # def random(self):
    #     if np.random.random() < 0.2:
    #         return np.random.rand(self.action_dim) - 1
    #     elif np.random.random() > 0.8:
    #         return np.random.rand(self.action_dim)
    #     else:
    #         return np.random.rand(self.action_dim) * 2 - 1  # 返回action_dim维的随机动作
